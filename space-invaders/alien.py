...
class Alien(pygame.sprite.Sprite):
    def __init__(self, type, x, y):
        super().__init__()
        self.type = type
        path = f"C:\\Users\\USER\\Documents\\UAS-EMBEDDED\\uas-embedded\\space-invaders\\assets\\alien_{type}.png"
...
class Mystery(pygame.sprite.Sprite):
    def __init__(self, screen_width, offset):
        ...
        self.offset = offset
        self.image = pygame.image.load("C:\\Users\\USER\\Documents\\UAS-EMBEDDED\\uas-embedded\\space-invaders\\assets\\mystery.png")
