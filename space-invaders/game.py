...
class Game:
    def __init__(self, screen_width, screen_height, offset):
        ...
        self.lives_heart = pygame.image.load("C:\\Users\\USER\\Documents\\UAS-EMBEDDED\\uas-embedded\\space-invaders\\assets\\heart.png")
    ...
    def create_mystery(self):
        self.mystery_group.add(Mystery(self.screen_width, self.offset))
    ...
    def check_collision(self):
        ...
        if self.spaceship_group.sprite.lasers_group:
            for laser_sprite in self.spaceship_group.sprite.lasers_group:
                ...
                if pygame.sprite.spritecollide(laser_sprite, self.mystery_group, True):
                    self.score += 500
                    self.explosion_sound.play()
                    laser_sprite.kill()
